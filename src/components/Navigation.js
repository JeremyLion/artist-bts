...
const Navigation = () => {
  return (
    <nav className=" bg-neutral-800 w-full flex relative justify-between items-center mx-auto px-8 h-20">
      ...
      <div className="hidden sm:block flex-shrink flex-grow-0 justify-start px-2">
          <div className="inline-block">
              <div className="inline-flex items-center max-w-full">
                  <button className="bg-white flex items-center flex-grow-0 flex-shrink pl-2 relative w-60 border rounded-full px-1  py-1" type="button">
      ...
      <div className="flex-initial">
        <div className="flex justify-end items-center relative">
          ...
          <div className="flex mr-4 items-center">
            {/* <Link to={'/'} className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full">
          ...
          <div className="block">
              <div className="inline relative">
                  <button type="button" className="bg-white inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                      <div className="pl-1">
                          <svg
                              viewBox="0 0 32 32"
                              xmlns="http://www.w3.org/2000/svg"
